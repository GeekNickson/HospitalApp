                ...
                <div class="col-md-8 mb-4 align-items-center my-auto"
                    ...
                    <table id="doctorsTable" class="table table-hover table-bordered table-sm my-auto"
                        ...
                        <tr>
                            ...
                            <th class="th-sm table-header-text"> Расписание</th>
                        </tr>
                        </thead>
                        <tbody>
                        </tbody>
...
<script>
    ...
    $(document).ready(function () {
        table = $('#doctorsTable').DataTable({
            ...
            columns: [
                ...
                {data: "schedule", className: "row-border", sortable: false}
            ],
            language: {
    ...
    $('#doctorsTable tbody').on('click', 'tr', function () {
        ...
        console.log(data.id);
        redirectPage('<%=pageName%>?doctor=' + data.id)
    });
</script>
</body>
</html>